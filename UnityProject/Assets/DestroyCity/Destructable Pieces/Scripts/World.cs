...
{
    // Represents the world city data
    public class World
    {
        ...
        public CityMesh Mesh { get; private set; }
        ...
        public Color32 GetPixelAt(Vector2I coord)
        {
            ...
            return this.CityLayer.GetAt(coord);
        }

        public IEnumerable<Vector2I> EnumerateChangeList()
        {
            foreach (var CityPixel in this.CityLayer.ChangeList)
            {
                yield return CityPixel;
            }
        ...
        {
            this.CityLayer.ChangeList.Clear();
            this.DynamicLayer.ChangeList.Clear();
        }

        // All changes are queued and committed on next Update
        public void ChangeCityColorAt(Vector2I position, Color32 newColorData)
        {
            this.CityLayer.SetAt(position, newColorData);
        }

        public void ChangeCityAlphaAt(Vector2I position, float newAlpha)
        {
            this.CityLayer.SetAlphaAt(position, newAlpha);
        }
    ...
    // Contains the all pixels of the City layer
    public class CityLayer
    {
        ...
        public CityLayer(Vector2I origin, Vector2I dimensions, Texture2D initialTexture = null)
        {
            this.Origin = origin;
    ...
    // Contains movable pixels of animated effects, drawn over City layer
    ...
    // One movable pixel of the City layer
